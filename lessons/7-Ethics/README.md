...
* **Công bằng** liên quan đến vấn đề quan trọng về *thiên vị mô hình*, có thể xảy ra khi sử dụng dữ liệu thiên vị để huấn luyện. Ví dụ, khi chúng ta cố gắng dự đoán khả năng một người nhận được công việc lập trình viên, mô hình có thể ưu tiên nam giới hơn - chỉ vì tập dữ liệu huấn luyện có thể đã thiên về đối tượng nam giới. cân bằng dữ liệu huấn luyện một cách cẩn thận và điều tra mô hình để tránh thiên vị, đồng thời đảm bảo rằng mô hình xem xét các đặc điểm liên quan hơn.
* **Độ tin cậy và an toàn**. Theo bản chất, các mô hình AI có thể mắc sai lầm. Một mạng nơ-ron trả về các xác suất, và tính đến điều này khi đưa ra quyết định. Mỗi mô hình đều có độ chính xác và độ hồi tưởng nhất định, và hiểu điều đó để ngăn chặn những tổn hại mà lời khuyên sai lầm có thể gây ra.
* **Quyền riêng tư và bảo mật** có một số tác động cụ thể đối với AI. Ví dụ, khi một số dữ liệu để huấn luyện mô hình, dữ liệu này bằng cách nào đó trở thành “tích hợp” vào mô hình. Một mặt, điều này tăng cường bảo mật và quyền riêng tư, mặt khác - nhớ dữ liệu nào đã được sử dụng để huấn luyện mô hình.
* **Tính bao gồm** có nghĩa là xây dựng AI để thay thế con người, mà là để hỗ trợ con người và làm cho công việc của chúng ta sáng tạo hơn. Điều này cũng liên quan đến tính công bằng, bởi vì khi xử lý các cộng đồng ít được đại diện, hầu hết các tập dữ liệu chúng ta thu thập có khả năng bị thiên vị, và đảm bảo rằng các cộng đồng đó được bao gồm và xử lý đúng cách bởi AI.
* **Tính minh bạch**. Điều này bao gồm việc đảm bảo rằng chúng ta luôn rõ ràng về việc AI đang được sử dụng. Ngoài ra, bất cứ khi nào có thể, sử dụng các hệ thống AI có thể *giải thích được*.
* **Trách nhiệm**. Khi các mô hình AI đưa ra một số quyết định, không phải lúc nào cũng rõ ai chịu trách nhiệm cho những quyết định đó. đảm bảo rằng chúng ta hiểu trách nhiệm của các quyết định AI nằm ở đâu. Trong hầu hết các trường hợp, đưa con người vào quy trình đưa ra các quyết định quan trọng, để những người thực sự chịu trách nhiệm.
