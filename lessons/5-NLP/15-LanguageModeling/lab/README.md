...
Trong bài thực hành này, chúng tôi thách thức bạn huấn luyện mô hình Word2Vec sử dụng kỹ thuật Skip-Gram. Huấn luyện một mạng với embedding để dự đoán các từ lân cận trong cửa sổ Skip-Gram rộng $N$ token. Bạn có thể sử dụng [mã từ bài học này](https://colab.research.google.com/github/hieubqdsm/ai-for-beginner-microsoft-vi/blob/main/lessons/5-NLP/15-LanguageModeling/CBoW-TF.ipynb) và chỉnh sửa một chút.
